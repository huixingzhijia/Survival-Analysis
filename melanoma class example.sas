...
set melanoma1;
run;
proc phreg data=melanomal2; 
*using model statement to tell sas fit the variables in the cox model;
   ...
   ld=likedisp lmax=maxdisp survival=surv
	resdev=deviance xbeta=Xb ressco=scoreulcer scoreclark scorethickness;
...
run;
proc print data=melanoma3 (obs=20); 
var  months censor dfthickness dfclark dfulcer likedisp maxdisp deviance scoreulcer scoreclark scorethickness; 
run;
